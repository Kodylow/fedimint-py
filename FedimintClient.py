...
class FedimintClient:
    ...
    def join(self, invite_code: str, set_default: bool = False):
        return self._post('/admin/join', {"inviteCode": invite_code, "setDefault": set_default})
    ...
    class LN:
        ...
        def create_invoice(self, request: LnInvoiceRequest, federation_id: str = None):
            return self.client._post_with_id('/ln/invoice', data=request, federation_id=federation_id)

        def await_invoice(self, request: AwaitInvoiceRequest, federation_id: str = None):
            return self.client._post_with_id('/ln/await-invoice', data=request, federation_id=federation_id)

        def pay(self, request: LnPayRequest, federation_id: str = None):
            return self.client._post_with_id('/ln/pay', data=request, federation_id=federation_id)

        def await_pay(self, request: AwaitLnPayRequest, federation_id: str = None):
            return self.client._post_with_id('/ln/await-pay', data=request, federation_id=federation_id)

        def list_gateways(self):
            return self.client._get('/ln/list-gateways')

        def switch_gateway(self, request: SwitchGatewayRequest, federation_id: str = None):
            return self.client._post_with_id('/ln/switch-gateway', data=request, federation_id=federation_id)

    class Wallet:
        def __init__(self, client):
            self.client = client

        def create_deposit_address(self, request: DepositAddressRequest, federation_id: str = None):
            return self.client._post_with_id('/wallet/deposit-address', data=request, federation_id=federation_id)

        def await_deposit(self, request: AwaitDepositRequest, federation_id: str = None):
            return self.client._post_with_id('/wallet/await-deposit', data=request, federation_id=federation_id)

        def withdraw(self, request: WithdrawRequest, federation_id: str = None):
            return self.client._post_with_id('/wallet/withdraw', data=request, federation_id=federation_id)
    ...
    class Mint:
        ...
        def reissue(self, request: ReissueRequest, federation_id: str = None):
            return self.client._post_with_id('/mint/reissue', data=request, federation_id=federation_id)

        def spend(self, request: SpendRequest, federation_id: str = None):
            return self.client._post_with_id('/mint/spend', data=request, federation_id=federation_id)

        def validate(self, request: ValidateRequest, federation_id: str = None):
            return self.client._post_with_id('/mint/validate', data=request, federation_id=federation_id)

        def split(self, request: SplitRequest, federation_id: str = None):
            return self.client._post_with_id('/mint/split', data=request, federation_id=federation_id)

        def combine(self, request: CombineRequest, federation_id: str = None):
            return self.client._post_with_id('/mint/combine', data=request, federation_id=federation_id)
