...
invoice_response = fedimint_client.modules.ln.create_invoice(invoice_request)
...
payment_response = fedimint_client.modules.ln.await_invoice(await_invoice_request)
